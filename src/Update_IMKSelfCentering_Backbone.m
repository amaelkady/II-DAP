function [Backbone]=Update_IMKSelfCentering_Backbone (Kx)
...
if RSA_Option==2 % Maintain Fy
    ...
    % Update affected paramters (Ull and Umax in this case)
    BackboneNoPD.Ull_pos0    = BackboneNoPD.FllFy_pos0*BackboneNoPD.Fy_pos0 /BackboneNoPD.Ke;
    ...
    % Check if unloading slope (Kul) exceeds the elastic slope (Ke) and
    % modify Kul if this is the case
    if BackboneNoPD.Kul_pos0>Kx
        BackboneNoPD.Kul_pos0=Kx;
    end
    
    % Update Uy
    BackboneNoPD.Uy_neg0     = BackboneNoPD.Fy_neg0 / BackboneNoPD.Ke;
    % Update affected paramters (Ull and Umax in this case)
    BackboneNoPD.Ull_neg0    = BackboneNoPD.FllFy_neg0*BackboneNoPD.Fy_neg0 /BackboneNoPD.Ke;
    ...
    % Check if unloading slope (Kul) exceeds the elastic slope (Ke) and
    % modify Kul if this is the case
    if BackboneNoPD.Kul_neg0>Kx
        BackboneNoPD.Kul_neg0=Kx;
    end
    ...
    Backbone.FmaxFy_pos0 = Backbone.Fmax_pos0 / Backbone.Fy_pos0;
    ...
    Backbone.Fll_pos0 =BackboneNoPD.Fll_pos0-(P*BackboneNoPD.Ull_pos0/H);
    ...
    Backbone.Fll_neg0 =BackboneNoPD.Fll_neg0-(P*BackboneNoPD.Ull_neg0/H);
    ...
    Backbone.Ull_pos0  = BackboneNoPD.Ull_pos0;
    Backbone.Kul_pos0  = BackboneNoPD.Kul_pos0;
    ...
    Backbone.Ull_neg0  = BackboneNoPD.Ull_neg0;
    Backbone.Kul_neg0  = BackboneNoPD.Kul_neg0;
...
if RSA_Option==3 % Maintain Uy
    ...
    % Update affected paramters (Fmax, Flll Ull and Fres in this case)
    ...
    BackboneNoPD.Fll_pos0  = BackboneNoPD.FllFy_pos0  * BackboneNoPD.Fy_pos0;
    BackboneNoPD.Ull_pos0  = BackboneNoPD.Fll_pos0  / BackboneNoPD.Ke;
    % Check if hardening slope (Kp) exceeds the elastic slope (Ke) and
    % modify Kp if this is the case
    Kp_pos=(BackboneNoPD.Fmax_pos0-BackboneNoPD.Fy_pos0)/(BackboneNoPD.Up_pos0);
    if Kp_pos>Kx
    ...
    BackboneNoPD.Fll_neg0  = BackboneNoPD.FllFy_neg0  * BackboneNoPD.Fy_neg0;
    BackboneNoPD.Ull_neg0  = BackboneNoPD.Fll_neg0  / BackboneNoPD.Ke;
    % Check if hardening slope (Kp) exceeds the elastic slope (Ke) and
    % modify Kp if this is the case
